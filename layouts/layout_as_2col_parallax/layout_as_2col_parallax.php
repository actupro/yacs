    <?php
    /**
     * 2 columns forest layout with parallax effect
    ...
    class Layout_as_2col_parallax extends Layout_interface {
        ...
        function layout($result) {
            ...
            // Initialisation
            $text = '<div class="yacs-forest-parallax" data-layout="2col-forest">';
            $count = 0;
        ...
        protected function build_card($item, $entity, $count) {
            ...
            return '
            <article class="forest-card '.$class.'" data-id="'.$item['id'].'">
